...
describe UserDetailsController do
  ...
  let(:valid_attributes) { { "birthdate" => "2014-04-24" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved user_detail as @user_detail" do
        ...
        post :create, {:user_detail => { "birthdate" => "invalid value" }}, valid_session
        assigns(:user_detail).should be_a_new(UserDetail)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested user_detail" do
        ...
        UserDetail.any_instance.should_receive(:update_attributes).with({ "birthdate" => "2014-04-24" })
        put :update, {:id => user_detail.to_param, :user_detail => { "birthdate" => "2014-04-24" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the user_detail as @user_detail" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        UserDetail.any_instance.stub(:save).and_return(false)
        put :update, {:id => user_detail.to_param, :user_detail => { "birthdate" => "invalid value" }}, valid_session
        assigns(:user_detail).should eq(user_detail)
      end
